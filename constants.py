...
sampling_rate   = 16000
random_state    = 42
test_size       = 0.20     # pentru split train/test în prepare_dataset.py (dacă e folosit)
validation_size = 0.20     # procent din train -> val (dacă e folosit)

# === Foldere/fișiere temporare ===
...
# === Mapări pentru denumiri de trăsături (folosite de utilities.encode_combination etc.) ===
